...
if (
  ...
  throw new Error("❌ Missing required env vars for create-pool API");
}

// ✅ Cloudflare R2 endpoints
const PRIVATE_R2_URL = `https://${R2_ACCOUNT_ID}.r2.cloudflarestorage.com`;
const PUBLIC_R2_URL =
  "https://pub-85c7f5f0dc104dc784e656b623d999e5.r2.dev"; // ✅ Replace with your actual Cloudflare public bucket binding if different
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // ✅ Create bonding curve pool transaction
...
// ✅ Creates a Meteora bonding curve pool transaction
